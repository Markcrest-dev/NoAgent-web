...
const features = [
  {
    ...
    desc: 'Search and secure your next apartment without paying a single naira in agency fees. What you see is what you pay.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Every landlord on NoAgent goes through a verification process. Look for the verified badge so you know exactly who you\'re dealing with.',
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    desc: 'Chat directly with landlords inside the app without sharing your personal phone number until you\'re ready.',
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    desc: 'Request and schedule a property inspection at a time that works for you — no agent coordinator needed.',
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    desc: 'Staying for 6 months? 2 years? Pick exactly how long you want to stay and get a transparent total cost upfront before you pay.',
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    desc: 'Your tenancy agreement is generated automatically after payment and accessible inside the app at any time.',
    icon: (
      <svg className="w-6 h-6 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f, i) => (
            <motion.div
              ...
              className="group bg-white rounded-2xl p-6 sm:p-7 border border-transparent hover:border-accent/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-default"
            >
              <div className="w-12 h-12 rounded-xl bg-icon-bg flex items-center justify-center mb-5 group-hover:bg-accent/20 transition-colors duration-300">
                {f.icon}
              </div>
              <h3 className="heading-display text-lg text-dark mb-2">{f.title}</h3>
