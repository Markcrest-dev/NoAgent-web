        ...
        <div className="space-y-16 md:space-y-0">
          {steps.map((step, i) => {
            ...
            return (
              ...
              >
                {/* Content side */}
                <div className={`${isEven ? 'md:order-2 md:text-left' : ''} relative`}>
                  {/* Watermark number */}
                  ...
                  <div className="relative">
                    ...
                    <h3 className="heading-display text-xl sm:text-2xl text-dark mb-3">
                      {step.title}
                    </h3>
                ...
                {/* Visual side — decorative step indicator */}
                <div className={`hidden md:flex ${isEven ? 'md:order-1 justify-end' : 'justify-start'} items-center`}>
                  <div className="relative w-64 h-48">
                    {/* Decorative card */}
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-primary/5 to-accent/5 border border-primary/10" />
                    <div className="absolute inset-4 rounded-xl bg-white shadow-sm border border-dark/5 flex items-center justify-center">
                      <span className="heading-display text-6xl text-primary/10">{step.num}</span>
                    </div>
                    {/* Accent dot */}
