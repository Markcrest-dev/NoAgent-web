...
export default function DownloadCTA() {
  return (
    <section id="download" className="bg-primary py-20 md:py-28 relative overflow-hidden">
      {/* Background grain */}
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.p
          ...
          className="text-hero-sub text-base sm:text-lg leading-relaxed mb-10"
        >
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-white text-primary font-bold text-base transition-all duration-200 hover:bg-bg hover:shadow-xl"
          >
            {/* Play Store SVG */}
